  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-[3%] mt-10 dark:bg-slate-800">
      <div className="flex gap-12">
        ...
        <div>
          <h2 className="text-6xl font-semibold text-gray-400">Hello,</h2>
          <h2 className="text-6xl font-semibold mt-4 mb-8 dark:text-white">
            <span className="text-4xl font-normal text-gray-400">I&apos;m</span>{" "}
            {user?.name}
          </h2>
          <p className="text-3xl font-bold dark:text-white">About Me</p>
          <hr className="horizontal border mt-2" />
          <p className="mt-4 text-lg text-gray-400">{user?.details}</p>
        </div>
      </div>
    </div>
  );
